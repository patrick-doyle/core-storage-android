 ...
 */
inline fun <reified T> CoreStorageGson.getOrDefault(key: String, defaultValue: T): T {
 ...
 */
fun <T> CoreStorageGson.getWithMigration(
    key: String,
 ...
 * @param migration used for migrating data from old storage systems
 */
inline fun <reified T> CoreStorageGson.getWithMigrationDefault(
    key: String,
    migration: CoreStorageMigration<T>,
    defaultValue: T
): T {
